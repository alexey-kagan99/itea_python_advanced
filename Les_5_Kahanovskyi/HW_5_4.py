...
class Registration:
    ...
    with shelve.open(FILE_NAME) as DATA_LIST:

        DATA_LIST['admen'] = 'admen'
    ...
    def set_data_list(self):
        ...
        with shelve.open(self.FILE_NAME) as self.DATA_LIST:
    ...
    def validator_login(self):
        ...
        with shelve.open(self.FILE_NAME) as self.DATA_LIST:
            ...
            for i in self.DATA_LIST.keys():
                ...
                self.data_logins.append(i)

            if self._log not in self.data_logins:
                return True
